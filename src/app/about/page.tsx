        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            <p className="text-base">
              ...
              strong emphasis on accessibility for users with disabilities.
              Working effectively within teams, I thrive on collaborating with
              cross-functional teams to deliver projects on time and within
              budget.
              <br />
              <br />
              Direct client communication is a key aspect of my role, allowing
              me to gather feedback and ensure timely delivery of requirements.
              Through these interactions, I&apos;ve gained valuable insights
              into client pain points, working with management to resolve them,
              resulting in successful project outcomes and increased client
              satisfaction.
              <br />
              <br />
